...
- If both underlying Kubernetes cluster and workload cluster use [Calico](https://projectcalico.docs.tigera.io/getting-started/kubernetes/quickstart) as CNI plugin, the underlying Kubernetes cluster calico-node daemonset's calico-node container should set environment variable [FELIX_ALLOWIPIPPACKETSFROMWORKLOADS](https://projectcalico.docs.tigera.io/reference/felix/configuration) to "true".
